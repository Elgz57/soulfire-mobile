                  ...
                  >
                    ...
                    <AboutProvider>
                      <SupportDialogProvider>
                        ...
                        {/*
                          Gated to dev builds. Upstream renders this
                          unconditionally, which is tolerable on desktop but
                          puts a floating devtools badge over the bottom-right
                          of a phone screen, where it overlaps primary actions.
                        */}
                        {import.meta.env.DEV && (
                          <TanStackDevtools
                            plugins={[
